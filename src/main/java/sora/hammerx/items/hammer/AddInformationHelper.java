...
public class AddInformationHelper {
    ...
    public static void addStandardInfo(ItemStack stack, World world, List<String> list, ITooltipFlag flagIn) {
        list.add(TextFormatting.WHITE + "" + TextFormatting.ITALIC + I18n.translateToLocal("phrase.hammerx.holdshift"));
        if (ConfigOptions.AddDurabilityInfo) {
            list.add(TextFormatting.GRAY + I18n.translateToLocal("hammerx.keyword.durability") + ": "
    ...
    public static void addExpandedInfo(ItemStack stack, World world, List<String> list, ITooltipFlag flagIn) {
        list.add(TextFormatting.GRAY + I18n.translateToLocal("phrase.hammerx.hammerinfo1"));
        list.add(TextFormatting.GRAY + I18n.translateToLocal("phrase.hammerx.hammerinfo2"));
        if(HammerInfoHandler.getUsesLP(stack)){
            list.add(TextFormatting.RED + net.minecraft.client.resources.I18n.format("hammerx.craft.help"));
        }
