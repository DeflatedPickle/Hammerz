...
import sora.hammerx.items.hammer.EnergyHandler;
...
public class AnvilEvent
{
	...
	{
		if (leftInput.getItem() == HammerX_Items.ItemHammer && rightInput.getCount() == 1 && HammerInfoHandler.isStackDarkSteelHammer(leftInput))
		{
